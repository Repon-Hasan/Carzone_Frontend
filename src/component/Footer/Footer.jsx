...
function Footer() {
  return (
    <div className="mt-6 rounded-t-xl shadow-inner">
      <footer className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 border-b pb-8">
          ...
          {/* Rentals */}
          <div>
            <h3 className="text-lg font-semibold mb-3">Rentals</h3>
            <ul className="space-y-2 text-sm">
              <li><NavLink to="/">Home</NavLink></li>
              <li><NavLink to="/available">Available Cars</NavLink></li>
              <li><NavLink to="/bookings">My Bookings</NavLink></li>
              <li><NavLink to="/add-car">List Your Car</NavLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              <a href="mailto:support@driveease.com" className="text-sm break-all hover:underline">
        ...
        {/* Bottom section */}
        <div className="flex flex-col md:flex-row items-center justify-between mt-6 text-sm text-gray-600 dark:text-gray-400">
          <p className="text-center md:text-left mb-2 md:mb-0">
            © {new Date().getFullYear()} DriveEase. All rights reserved.
          </p>
          <div className="flex space-x-3">
            <a href="https://www.facebook.com/" className="hover:text-indigo-500" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://twitter.com" className="hover:text-indigo-500" target="_blank" rel="noopener noreferrer">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
